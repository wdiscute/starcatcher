...
{
    public void trigger(ServerPlayer player, Identifier rl, Rarity rarity, int time, boolean perfectCatch)
    {
            ...
            implements SimpleCriterionTrigger.SimpleInstance
    {
        ...
        public boolean matches(Identifier rl, Rarity rarity, int time, boolean perfectCatch)
        {
