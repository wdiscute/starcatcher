...
public class SCConfig
{
    ...
    public static final ForgeConfigSpec.BooleanValue REMOVE_NOTIFICATION_ON_HOVER = BUILDER_CLIENT
    ...
    public static final ForgeConfigSpec.EnumValue<SizeAndWeight.Units> UNIT = BUILDER_CLIENT
            .translation("starcatcher.configuration.units")
            .defineEnum("units", SizeAndWeight.Units.METRIC);

    public static final ForgeConfigSpec.EnumValue<FishingGuideScreen.Sort> SORT = BUILDER_CLIENT
            .translation("starcatcher.configuration.sort")
            .defineEnum("sort", FishingGuideScreen.Sort.ALPHABETICAL_DOWN);

    public static final ForgeConfigSpec.BooleanValue ENABLE_VILLAGER_SOUNDS = BUILDER_CLIENT
    ...
    public static final ForgeConfigSpec.BooleanValue ENABLE_HIT_SOUNDS = BUILDER_CLIENT
    ...
    public static final ForgeConfigSpec.BooleanValue ENABLE_MISS_SOUND = BUILDER_CLIENT
    ...
    public static final ForgeConfigSpec.BooleanValue GIVE_ROD = BUILDER_SERVER
    ...
    public static final ForgeConfigSpec.BooleanValue ENABLE_GUIDE_HELP_PAGES = BUILDER_SERVER
    ...
    public static final ForgeConfigSpec.DoubleValue HP_RATE_MULTIPLIER = BUILDER_SERVER
    ...
    public static final ForgeConfigSpec.DoubleValue HANDLE_SPEED_MULTIPLIER = BUILDER_SERVER
    ...
    public static final ForgeConfigSpec.BooleanValue HIDE_ENTRIES_UNTIL_FOUND = BUILDER_SERVER
    ...
    public static final ForgeConfigSpec.BooleanValue SAVE_DATA_TO_ITEMS = BUILDER_SERVER
    ...
    public static final ForgeConfigSpec.IntValue BASE_MIN_TICKS_TO_FISH = BUILDER_SERVER
    ...
    public static final ForgeConfigSpec.IntValue BASE_MAX_TICKS_TO_FISH = BUILDER_SERVER
    ...
    public static final ForgeConfigSpec.DoubleValue BASE_CHANCE_TO_FISH = BUILDER_SERVER
    ...
    public static final ForgeConfigSpec.BooleanValue RESTRICT_TACKLE_BOX_TO_TAG = BUILDER_SERVER
    ...
    public static final ForgeConfigSpec.DoubleValue FISH_MAX_SCALE = BUILDER_SERVER
    ...
    public static final ForgeConfigSpec.DoubleValue FISH_MIN_SCALE = BUILDER_SERVER
    ...
    public static final ForgeConfigSpec.BooleanValue HIDE_TREASURES = BUILDER_SERVER
    ...
    public static final ForgeConfigSpec.BooleanValue HIDE_CATCHES = BUILDER_SERVER
            .comment("Hides the catch during minigame")
            .translation("starcatcher.configuration.hide_catches")
            .define("hide_catches", false);

    public static final ForgeConfigSpec.BooleanValue ENABLE_ROD_DURABILITY = BUILDER_SERVER
    ...
    public static final ForgeConfigSpec.BooleanValue ALLOW_GUIDE_KEYBIND = BUILDER_SERVER
