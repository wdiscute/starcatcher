...
public class SCConfig
{
    ...
    public static final ForgeConfigSpec.IntValue MINIGAME_X_OFFSET = BUILDER_CLIENT
            .translation("starcatcher.configuration.x_offset")
            .defineInRange("minigame_x_offset", 0, -10000, 10000);

    public static final ForgeConfigSpec.IntValue MINIGAME_Y_OFFSET = BUILDER_CLIENT
    ...
    public static final ForgeConfigSpec.EnumValue<FishProperties.SizeAndWeight.Units> UNIT = BUILDER_CLIENT
    ...
    public static final ForgeConfigSpec.BooleanValue ENABLE_VILLAGER_SOUND = BUILDER_CLIENT
            .translation("starcatcher.configuration.enable_villager_sound")
            .define("enable_villager_sound", true);

    public static final ForgeConfigSpec.BooleanValue ENABLE_HIT_SOUND = BUILDER_CLIENT
    ...
    public static final ForgeConfigSpec.DoubleValue FISH_PLAYER_MESSAGES_CHANCE = BUILDER_SERVER
    ...
    public static final ForgeConfigSpec.BooleanValue ENABLE_ROD_MENU = BUILDER_SERVER
...
//    public static final ForgeConfigSpec.ListValueSpec BASE_MODIFIERS = BUILDER_SERVER
