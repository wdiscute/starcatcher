...
{
    public static final Type<SBSetEditableMessagePayload> TYPE = new Type<>(Starcatcher.rl("set_editable_message"), SBSetEditableMessagePayload.class);

    public static final StreamCodec<SBSetEditableMessagePayload> STREAM_CODEC = StreamCodec.composite(
