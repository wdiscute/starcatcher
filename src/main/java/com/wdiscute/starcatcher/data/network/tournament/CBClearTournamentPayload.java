...
{
    public static final CustomPacketPayload.Type<CBClearTournamentPayload> TYPE =
            new CustomPacketPayload.Type<>(Starcatcher.rl("cb_active_tournament_update"), CBClearTournamentPayload.class);
