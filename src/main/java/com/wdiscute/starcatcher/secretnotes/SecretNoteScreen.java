...
public class SecretNoteScreen extends Screen {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            if (I18n.exists(key))
                guiGraphics.drawString(this.font, Tooltips.decodeTranslationKey(key), leftPos + 140, topPos + 55 + 9 * i, 0x00000000, false);
            else
                break;
        }
    }
    ...
    private void renderImage(GuiGraphics guiGraphics, ResourceLocation rl) {
        guiGraphics.blit(rl, leftPos, topPos, 0, 0, 512, 256, 512, 256);
    }
