...
public class Suneater<T extends Entity> extends EntityModel<FishEntityRenderState>
{
	private static final String NAME = "suneater";
	...
	public Suneater(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = fish.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -5.0F, -4.0F, 2.0F, 5.0F, 9.0F, new CubeDeformation(0.0F))
				.texOffs(16, 22).addBox(-1.0F, -5.0F, -5.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(22, 22).addBox(-1.0F, -5.0F, -6.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
